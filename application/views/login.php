...
<head>
    ...
    <link href="<?= base_url('assets') ?>/ample-admin-lite/html/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="<?= base_url( 'assets/datepicker/datepicker3.min.css' ) ?>">
...
<body class="gray-bg">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?= form_open( 'auth', [ 'id' => 'login-form', 'role' => 'form', 'style' => 'display: block;' ] ) ?>
                                ...
                                <?= form_open( 'auth', [ 'id' => 'register-form', 'role' => 'form', 'style' => 'display: none;' ] ) ?>
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="nama" class="form-control" placeholder="Nama" tabindex="2">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" tabindex="2">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3">
                                                <input type="submit" name="register" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Daftar Sekarang">
                                            </div>
                                        </div>
                                    </div>
                                <?= form_close() ?>
    ...
    <!-- Mainly scripts -->
    <script src="<?= base_url('assets') ?>/pato/vendor/jquery/jquery-3.2.1.min.js"></script>
    <script src="<?= base_url('assets') ?>/ample-admin-lite/html/bootstrap/dist/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?= base_url( 'assets/datepicker/datepicker3.min.js' ) ?>"></script>
