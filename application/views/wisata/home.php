			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30">
					<div class="wrap-pic-welcome size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="<?= base_url( 'assets/pato' ) ?>/images/our-story-01.jpg" alt="IMG-OUR">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="section-intro">
		<div class="header-intro parallax100 t-center p-t-135 p-b-158" style="background-image: url(<?= base_url( 'assets/pato' ) ?>/images/bg-intro-01.jpg);">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="<?= base_url( 'assets/pato' ) ?>/images/intro-01.jpg" alt="IMG-INTRO"></a>
							</div>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="<?= base_url( 'assets/pato' ) ?>/images/intro-02.jpg" alt="IMG-INTRO"></a>
							</div>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="<?= base_url( 'assets/pato' ) ?>/images/intro-04.jpg" alt="IMG-INTRO"></a>
							</div>
	...
	<section class="section-event">
		<div class="wrap-slick2">
			<div class="slick2">
				<div class="item-slick2 item1-slick2" style="background-image: url(<?= base_url( 'assets/pato' ) ?>/images/bg-event-01.jpg);">
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="zoomIn">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg1-blo2" style="background-image: url(<?= base_url( 'assets/pato' ) ?>/images/event-02.jpg);">
					...
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="fadeInDown">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg2-blo2" style="background-image: url(<?= base_url( 'assets/pato' ) ?>/images/event-06.jpg);">
									<div class="time-event size10 txt6 effect1">
				...
				<div class="item-slick2 item3-slick2" style="background-image: url(<?= base_url( 'assets/pato' ) ?>/images/bg-event-04.jpg);">
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							<!-- - -->
							<div class="title-event t-center m-b-52">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="rotateInUpLeft">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg3-blo2" style="background-image: url(<?= base_url( 'assets/pato' ) ?>/images/event-01.jpg);">
									<div class="time-event size10 txt6 effect1">
										<span class="txt-effect1 flex-c-m">
											08:00 PM Tuesday - 21 November 2018
										</span>
			...
			<div class="row">
				...
				<div class="col-lg-6 p-b-30 p-t-18">
					<div class="wrap-pic-booking size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="<?= base_url( 'assets/pato' ) ?>/images/booking-01.jpg" alt="IMG-OUR">
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Video -->
	<section class="section-video parallax100" style="background-image: url(<?= base_url( 'assets/pato' ) ?>/images/bg-cover-video-02.jpg);">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="<?= base_url( 'assets/pato' ) ?>/blog-detail.html"><img src="<?= base_url( 'assets/pato' ) ?>/images/blog-01.jpg" alt="IMG-INTRO"></a>
						...
						<div class="wrap-text-blo1 p-t-35">
							<a href="<?= base_url( 'assets/pato' ) ?>/blog-detail.html"><h4 class="txt5 color0-hov trans-0-4 m-b-13">
							...
							<a href="<?= base_url( 'assets/pato' ) ?>/blog-detail.html" class="txt4">
								Continue Reading
								<i class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i>
							</a>
						</div>
				...
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="<?= base_url( 'assets/pato' ) ?>/blog-detail.html"><img src="<?= base_url( 'assets/pato' ) ?>/images/blog-02.jpg" alt="IMG-INTRO"></a>
				...
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="<?= base_url( 'assets/pato' ) ?>/blog-detail.html"><img src="<?= base_url( 'assets/pato' ) ?>/images/blog-03.jpg" alt="IMG-INTRO"></a>
